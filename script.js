...
vdocon.addEventListener("mousemove",function(detail){
    gsap.to(playbtn,{
        left:detail.x-0,
        top:detail.y-1
    })
...
// cuz we cant use locomotive and scroll trigger at the same time,
// we have to write a code which can do both operation
